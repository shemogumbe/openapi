...
class SpecificationsItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /priceAssessments/specifications/{id}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/priceAssessments/specifications/{id}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SpecificationsGetResponse]:
        """
        Returns a price assessment specification entity for a valid identifier.
