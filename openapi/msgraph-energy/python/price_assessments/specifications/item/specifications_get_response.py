...
class SpecificationsGetResponse(AdditionalDataHolder, Parsable):
    """
    PriceAssessmentSpecification entity.
    """
    ...
    data: Optional[PriceAssessmentSpecificationModel] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_object_value(PriceAssessmentSpecificationModel)),
