...
class IndicesGetResponse(AdditionalDataHolder, Parsable):
    """
    A list of Index entities.
    """
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: Dict[str, Any] = field(default_factory=dict)

    # The data property
    data: Optional[List[IndexModel]] = None
    # The included property
    included: Optional[List[IndicesGetResponse_included]] = None
    # The links property
    links: Optional[IndicesGetResponse_links] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_collection_of_object_values(IndexModel)),
            "included": lambda n : setattr(self, 'included', n.get_collection_of_object_values(IndicesGetResponse_included)),
            "links": lambda n : setattr(self, 'links', n.get_object_value(IndicesGetResponse_links)),
        }
        return fields
