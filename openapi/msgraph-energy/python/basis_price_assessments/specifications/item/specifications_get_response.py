...
class SpecificationsGetResponse(AdditionalDataHolder, Parsable):
    """
    BasisPriceAssessmentSpecification entity.
    """
    ...
    data: Optional[BasisPriceAssessmentSpecificationModel] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_object_value(BasisPriceAssessmentSpecificationModel)),
