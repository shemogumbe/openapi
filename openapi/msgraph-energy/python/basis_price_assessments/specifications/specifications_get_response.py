...
class SpecificationsGetResponse(AdditionalDataHolder, Parsable):
    """
    A list of BasisPriceAssessmentSpecification entities.
    """
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: Dict[str, Any] = field(default_factory=dict)

    # The data property
    data: Optional[List[BasisPriceAssessmentSpecificationModel]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_collection_of_object_values(BasisPriceAssessmentSpecificationModel)),
