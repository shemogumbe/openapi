...
if TYPE_CHECKING:
    ...
    from .basis_price_assessments_get_response_links import BasisPriceAssessmentsGetResponse_links

@dataclass
class BasisPriceAssessmentsGetResponse(AdditionalDataHolder, Parsable):
    """
    A list of BasisPriceAssessment entities.
    """
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: Dict[str, Any] = field(default_factory=dict)

    # The data property
    data: Optional[List[BasisPriceAssessmentModel]] = None
    # The included property
    included: Optional[List[BasisPriceAssessmentsGetResponse_included]] = None
    # The links property
    links: Optional[BasisPriceAssessmentsGetResponse_links] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_collection_of_object_values(BasisPriceAssessmentModel)),
            "included": lambda n : setattr(self, 'included', n.get_collection_of_object_values(BasisPriceAssessmentsGetResponse_included)),
            "links": lambda n : setattr(self, 'links', n.get_object_value(BasisPriceAssessmentsGetResponse_links)),
        }
        return fields
