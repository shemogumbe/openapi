...
class CurrenciesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/currencies{?page%5Bafter%5D*,page%5Bsize%5D*}", path_parameters)
    
    def by_id(self,id: str) -> CurrenciesItemRequestBuilder:
        """
        Gets an item from the GraphPythonv1.currencies.item collection
        param id: The Id of the currency for which the user wants to retrieve data.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[CurrenciesRequestBuilderGetQueryParameters]] = None) -> Optional[CurrenciesGetResponse]:
        """
        Returns a list of currencies sorted by `name` in ascending order. If there is no data, then an empty array will be returned.
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CurrenciesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Returns a list of currencies sorted by `name` in ascending order. If there is no data, then an empty array will be returned.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class CurrenciesRequestBuilderGetQueryParameters():
        """
        Returns a list of currencies sorted by `name` in ascending order. If there is no data, then an empty array will be returned.
        """
    ...
    @dataclass
    class CurrenciesRequestBuilderGetRequestConfiguration(RequestConfiguration[CurrenciesRequestBuilderGetQueryParameters]):
        """
